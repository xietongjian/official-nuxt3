  ...
  >
    ...
    >
      <span
        ...
        :key="item.name"
        @click="item.path ? navigatePage(item.path) : item.page ? navigate(item.page) : ''"
      >
...
const navList = [
  { name: "menu.home", page: 1, path: "/" },
  { name: "menu.solution", page: 1, path: "/solution" },
  { name: "menu.cases", page: 1, path: "/cases" },
  { name: "menu.examples", page: 1, path: "/examples" },
  /*{
    name: "nav_2",
    children: [
      {
